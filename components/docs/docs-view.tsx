...
const SECTIONS: SectionMeta[] = [
  { id: "overview", title: "A third path in AI" },
  { id: "dimensionality", title: "Why 10,000 dimensions" },
  { id: "hypervector", title: "The hypervector: ±1 in 10,000 slots" },
  { id: "operations", title: "Three operations build all of thought" },
  { id: "cleanup", title: "Cleanup memory: noise back into meaning" },
  { id: "structures", title: "Encoding records, sequences and graphs" },
  { id: "analogy", title: "Reasoning by analogy: the Dollar of Mexico" },
  { id: "holographic", title: "Holographic memory and fault tolerance" },
  { id: "oneshot", title: "One-shot, instant learning" },
  { id: "collective", title: "A brain the whole internet builds" },
  { id: "capacity", title: "Finite capacity and graceful forgetting" },
  { id: "architecture", title: "How hiperbrain is built" },
  { id: "commands", title: "The command language" },
  { id: "compare", title: "HDC vs. large language models" },
  { id: "limits", title: "Where it is honest about its limits" },
  { id: "science", title: "The science behind it" },
  { id: "faq", title: "Frequently asked questions" },
  { id: "glossary", title: "Glossary" },
  { id: "sdk", title: "Use the engine yourself: @hiperbrain/core" },
];
    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="mt-10 grid gap-10 sm:mt-12 lg:grid-cols-[240px_1fr]">
        ...
        <div className="min-w-0">
          <Accordion n={1} meta={SECTIONS[0]} open={open} toggle={toggle} register={register}>
            <p>
            ...
            <p>
              This page is the long-form explanation of how that works, section by
              section. Every claim here maps to code you can read in{" "}
              <Mono>packages/core/src/</Mono>. Use the menu on the left to jump around, and
              expand only the parts you care about.
            </p>
          </Accordion>

          <Accordion n={2} meta={SECTIONS[1]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={3} meta={SECTIONS[2]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={4} meta={SECTIONS[3]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={5} meta={SECTIONS[4]} open={open} toggle={toggle} register={register}>
            <p>
...
cleanup(query) = argmax over all known
          ...
          <Accordion n={6} meta={SECTIONS[5]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={7} meta={SECTIONS[6]} open={open} toggle={toggle} register={register}>
            <p>
...
{`cleanup( Dollar ⊗ (USA ⊗ Mexico) )  ->  Peso`}
          ...
          <Accordion n={8} meta={SECTIONS[7]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={9} meta={SECTIONS[8]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={10} meta={SECTIONS[9]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={11} meta={SECTIONS[10]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={12} meta={SECTIONS[11]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={13} meta={SECTIONS[12]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={14} meta={SECTIONS[13]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={15} meta={SECTIONS[14]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={16} meta={SECTIONS[15]} open={open} toggle={toggle} register={register}>
            <p>
          ...
          <Accordion n={17} meta={SECTIONS[16]} open={open} toggle={toggle} register={register}>
            <Faq
          ...
          <Accordion n={18} meta={SECTIONS[17]} open={open} toggle={toggle} register={register}>
          ...
          <Accordion n={19} meta={SECTIONS[18]} open={open} toggle={toggle} register={register}>
            <p>
...
brain.analogy("Yen", "Japan", "France"); // -> [{ name: "Euro", ... }]`}
            ...
            <p className="mt-3">
              Or reach for the raw primitives - <Mono>bind</Mono>, <Mono>bundle</Mono>,{" "}
              <Mono>permute</Mono>, <Mono>cosineSimilarity</Mono> - and the{" "}
              <Mono>Brain</Mono> facade for records, text classification and sequence
              memory. Everything is deterministic: the same input always yields the same
              vector, so results are reproducible and testable.
            </p>
